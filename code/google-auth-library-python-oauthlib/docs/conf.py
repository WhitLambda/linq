...
version = pkg_resources.get_distribution('google-auth-oauthlib').version
...
htmlhelp_basename = 'google-auth-oauthlibdoc'
...
latex_documents = [
    (master_doc, 'google-auth-oauthlib.tex',
...
man_pages = [
    (master_doc, 'google-auth-oauthlib', 'google-auth-oauthlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'google-auth-oauthlib', 'google-auth-oauthlib Documentation',
     author, 'google-auth-oauthlib', 'One line description of project.',
     'Miscellaneous'),
]
