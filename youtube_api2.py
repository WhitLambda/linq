...
def get_authenticated_service():
    ...
    flow = InstalledAppFlow.from_client_secrets_file("client_secret_420065976324-nsguat4ftgvgmi4m3gaa3lokl3hi8prj.apps.googleusercontent.com.json", scopes)
    ...
    return build(api_service_name, api_version, credentials = credentials)
     ...
     #function from: https://github.com/ItsCEED/Youtube-Comment-Bot/blob/master/yt.py
